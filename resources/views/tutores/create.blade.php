    ...
    @endif
      <form method="post" action="{{ route('contacts.store') }}">
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="nombre_emp" value="{{old('nombre_emp')}}"/>
              {!!$errors->first('nombre_emp', '<small class="text-danger">:message</small></br>')!!}
          </div>

          <div class="form-group">    
              <label for="tipo_identidad">Tipo de documento:</label>
              <input type="text" class="form-control" name="tipo_identidad" value="{{old('tipo_identidad')}}"/>
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="nie_emp" value="{{old('nie_emp')}}"/>
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="nombre_tutor" value="{{old('nombre_tutor')}}"/>
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="apellido_tutor" value="{{old('apellido_tutor')}}"/>
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="apellido2_tutor" value="{{old('apellido2_tutor')}}"/>
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="pais_doc_identidad" value="{{old('pais_doc_identidad')}}"/>
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="tlf_tutor" value="{{old('tlf_tutor')}}"/>
